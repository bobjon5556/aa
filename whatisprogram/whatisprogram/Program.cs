    ...
    internal class Program
    {
        ...
        변수
            ...
            */
            ...
            //직접
            Console.WriteLine("프로그래밍");

            //문자열 보간 이용 방법
            int a = 10;
            int b = 20;
            int c = 30;
            Console.WriteLine($"string example1 : {a} + {b} + {c}  = {a + b + c}");
            ...
            for (int i = 1; i < 10; ++i)
            {
                ...
                {
                    //C# Format 이용
                    Console.WriteLine("{0, 5} x {1, -5} = {2, 10}", i, j, i * j);

                    //C# 문자열 보간 이용
                    //Console.WriteLine($"{i, 5} x {j, -5} = {i*j}");
                }
            }
            ...
            //변수
            string str1 = "경일게임아카데미";
            Console.WriteLine(str1);

            string str2 = "모바일 프로그래밍 과정 C";
